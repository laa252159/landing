        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="section-title  text-center">
                    <h2>О нас</h2>
                    <span class="title-line"><i class="fa fa-car"></i></span>
                    <p>Cars64.ru - это сервис, при помощи которого Вы сможете быстро оставить заявку на участие в аукционе. На первом этапе к Вам подъедет независимый оценщик нашего сервиса, он сфотографирует Ваш авто и детально изучит его состояние. Далее фото и видео Вашего авто мы выложим на электронный аукцион. В данном аукционе участвуют как обычные покупатели так и частные дилеры, которые покупают авто для перепродажи. Ценообразование очень простое: тот, кто из покупателей предложит максимальную сумму, тот и приобретает Ваш автомобиль. Наш сервис нацелен на то, чтобы Вы получили максимальную сумму денег за свой автомобиль в очень короткий срок.</p>
                </div>
            </div>
            <!-- Section Title End -->
        </div>
