            ...
            <div class="col-lg-12">
                <div class="section-title  text-center">
                    ...
                    <p>Самостоятельные поиски покупателя, оформление документов и прочие нюансы купли-продажи автомобиля
                        могут занять недели, а порой – даже месяцы. Наш сервис решает поставленные задачи в сжатые
        ...
        <div class="row">
            ...
            <div class="col-lg-4 text-center">
                <div class="service-item">
                    ...
                    <p>Редкий автомобилист не сталкивался с серьезными ДТП, проживая в Саратове. Техника, получившая
                        ...
                        язык — совершенно себя не оправдывают. Выручить способен наш сервис по срочному выкупу битых
                        авто, у такого решения немало явных преимуществ.</p>
                </div>
            </div>
            <!-- Single Service End -->
            ...
            <div class="col-lg-4 text-center">
                <div class="service-item">
                    ...
                    <p>ВЫКУП АВТОМОБИЛЕЙ ПРИМИУМ КЛАССА
                        Хотите решить внезапно возникшие финансовые вопросы путем реализации машины премиального
                        ...
                        обращения. Автовыкуп осуществляется через аукцион по максимальной стоимости.</p>
                </div>
            </div>
            <!-- Single Service End -->
        </div>
