...
<head>
    ...
    <title>Главная - Cars64.ru</title>
    <meta name="description" content="Cars64.ru - это бесплатный сервис, через который можно легко продать и купить автомобиль
                                    ...
                                    Процесс торгов происходит на сайте в разделе АУКЦИОН: тот, кто из участников предложит
                                    ...
                                    свой автомобиль в заранее обговорённый и сжатый срок">
            ...
            <div class="row">
                ...
                <div class="col-lg-7 text-right">
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="slider-right-text">
                                <h1>Мы поможем тебе продать автомобиль ВЫГОДНО</h1>
                                <p> - это бесплатный сервис, через который можно легко продать и купить автомобиль
                                    в Саратове посредством электронного аукциона. В данном аукционе участвуют
                                    обычные покупатели, а также частные дилеры, которые выкупают автомобиль для дальнейшей перепродажи.
                                    <br>Процесс торгов происходит на сайте в разделе АУКЦИОН: тот, кто из участников предложит
                                    максимальную сумму, тому приходит сообщение с контактами продавца и он приобретает данный автомобиль.
                                    Наш сервис cars64.ru нацелен на то, чтобы Вы быстро получили максимально возможную сумму денег за
                                    свой автомобиль в короткий срок</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="section-title  text-center">
                    <h2>Какие авто могут учавствовать в аукционе:</h2>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 text-center">
                <div class="service-item">
                    ...
                    <h3>Битые автомобили после ДТП или аварии</h3>
                    <p> Автомобиль получивший повреждения, ставит владельца перед дилеммой — заняться восстановлением
                        автомобиля, либо продать его и забыть про эту проблему. Ремонтировать автомобиль — хлопотное,
                        неблагодарное занятие, отнимающее немало времени и денег. Практика показывает, что поиск
                        нормального сервиса, заказ комплектующих, процесс ожидания, в переводе на финансовый
                        язык — совершенно себя не оправдывают. Выручить способен наш сервис по быстрой продаже
            ...
            <div class="col-lg-4 text-center">
                <div class="service-item">
                    ...
                    <p>Оформляя авто в кредит, не каждый человек может точно спрогнозировать уровень своих доходов в
                        ...
                        виде неподъемных ежемесячных выплат. Наш сервис поможет выгодно и безопасно избавиться
                        от этой проблемы</p>
                </div>
            </div>
            <!-- Single Service End -->
            ...
            <div class="col-lg-4 text-center">
                <div class="service-item">
                    <i class="fa fa-automobile"></i>
                    <h3>Автомобили в хорошем техническом состоянии</h3>
                    <p>Хотите поскорее продать свой автомобиль? Устали ждать звонков от частных покупателей, торговаться
                        ...
                        Вы продадите Вашу машину быстро, выгодно и максимально дорого, без лишних претензий и
                        вопросов</p>
                </div>
            </div>
            <!-- Single Service End -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-footer-widget">
                        ...
                        <div class="widget-body">
                            <p>Мы находимся в Саратове, наш оценщик может выехать в любую точку Саратова и
