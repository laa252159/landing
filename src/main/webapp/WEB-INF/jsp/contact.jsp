                ...
                <div class="contact-form">
                    <form action="index.html">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="email-input">
                                    <input type="email" placeholder="Мобильный телефон">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="website-input">
                                    <input type="url" placeholder="Марка и модель автомобиля">
                                </div>
                            </div>
                        ...
                        <div class="message-input">
                            <textarea name="review" cols="30" rows="10" placeholder="Текст сообщения"></textarea>
                        </div>
